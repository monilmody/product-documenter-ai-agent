# Create a clean version without emoji characters
$cleanScript = @'
...
# Save the clean file
$cleanScript | Out-File -FilePath "start_monitoring_clean.ps1" -Encoding ASCII -Force

Write-Host "Clean file created: start_monitoring_clean.ps1" -ForegroundColor Green
Write-Host "Now run: .\start_monitoring_clean.ps1" -ForegroundColor Yellow